...
Add-HostsEntry "cm.easybank.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.easybank.localhost"
}
Add-HostsEntry "id.easybank.localhost"
Add-HostsEntry "www.easybank.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.easybank.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.easybank.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.easybank.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.easybank.localhost"
