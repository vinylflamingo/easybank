...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.easybank.localhost/ --auth https://id.easybank.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.easybank.localhost/ --auth https://id.easybank.localhost/ --allow-write true
}
